"""
Django settings for morning_resonance_41515 project.
...
ROOT_URLCONF = 'morning_resonance_41515.urls'
...
WSGI_APPLICATION = 'morning_resonance_41515.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_resonance_41515 API",
    "DESCRIPTION": "API documentation for morning_resonance_41515 App",
    "VERSION": "v1",
}
